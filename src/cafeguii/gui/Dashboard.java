...
/**
 *
 * @author Sakib Ahmed Shishir, Choitonno Saha, Farhin Ahmed 
 */
public class Dashboard extends JFrame {
    ...
    public void init() {
        ...
        items = new CoffeeShopItem[]{
                new CoffeeShopItem("Hot Coffee", 60.0, "/cafeguii/images2/hotcoffee.png", jLabelImage1),
                new CoffeeShopItem("Cold Coffee", 80.0, "/cafeguii/images2/coldcoffee.png", jLabelImage2),
                new CoffeeShopItem("Milk Tea", 20.0, "/cafeguii/images2/milktea.jpeg", jLabelImage3),
                new CoffeeShopItem("Burger", 100.0, "/cafeguii/images2/burger.jpeg", jLabelImage4),
                new CoffeeShopItem("Mineral Water", 20.0, "/cafeguii/images2/water.jpeg", jLabelImage5),
                new CoffeeShopItem("Khichuri", 50.0, "/cafeguii/images2/khichuri.png", jLabelImage6),
                new CoffeeShopItem("Coca-Cola", 25.0, "/cafeguii/images2/cocacola.png", jLabelImage7),
                new CoffeeShopItem("Lemontea", 25.0, "/cafeguii/images2/lemontea.jpg", jLabelImage8),
                new CoffeeShopItem("Sandwich", 70.0, "/cafeguii/images2/sandwitch.jpeg", jLabelImage9),
                new CoffeeShopItem("Chawmin", 70.0, "/cafeguii/images2/chawmin.png", jLabelImage10),
                new CoffeeShopItem("Biriwani", 130.0, "/cafeguii/images2/biriwani.png", jLabelImage11),
                new CoffeeShopItem("Pizza", 75.0, "/cafeguii/images2/pizza.jpeg", jLabelImage12),
                new CoffeeShopItem("Lacchi", 70.0, "/cafeguii/images2/lacchi.png", jLabelImage13),
                new CoffeeShopItem("Fried Rice", 120.0, "/cafeguii/images2/friedrice.png", jLabelImage14),
                new CoffeeShopItem("Chicken Fry", 90.0, "/cafeguii/images2/chickenfry.png", jLabelImage15)
        };
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new Font("Potti Sreeramulu", 1, 25)); // 
        ...
        jLabelProduk2.setText("Cold Coffee");

        jLabel16.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel16.setText("80 Tk");
        ...
        jLabel26.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel26.setText("Price:");

        jLabel27.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel27.setText("Quantity:");

        jLabel28.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel28.setText("Purchase:");

        jLabelProduk1.setFont(new Font("Potti Sreeramulu", 1, 20)); 
        jLabelProduk1.setHorizontalAlignment(SwingConstants.CENTER);
        jLabelProduk1.setText("Hot Coffee");
        
        

        jLabel30.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel30.setText("60 Tk");

        jSpinner1.setFont(new Font("Rasa Medium", 1, 16)); 
        ...
        jLabel40.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel40.setText("Price:");

        jLabel41.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel41.setText("Quantity:");

        jLabel42.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel42.setText("Purchase:");

        jLabelProduk3.setFont(new Font("Potti Sreeramulu", 1, 20)); 
        jLabelProduk3.setHorizontalAlignment(SwingConstants.CENTER);
        jLabelProduk3.setText("Milk Tea");

        jLabel44.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel44.setText("20 Tk");

        jSpinner3.setFont(new Font("Rasa Medium", 1, 16)); 
        ...
        jLabel47.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel47.setText("Price:");

        jLabel48.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel48.setText("Quantity:");

        jLabel49.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel49.setText("Purchase:");

        jLabelProduk4.setFont(new Font("Potti Sreeramulu", 1, 20)); 
        jLabelProduk4.setHorizontalAlignment(SwingConstants.CENTER);
        jLabelProduk4.setText("Burger");

        jLabel51.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel51.setText("100 Tk");

        jSpinner4.setFont(new Font("Rasa Medium", 1, 16)); 
        ...
        jLabel54.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel54.setText("Price:");

        jLabel55.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel55.setText("Quantity:");

        jLabel56.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel56.setText("Purchase:");

        jLabelProduk5.setFont(new Font("Potti Sreeramulu", 1, 20)); 
        jLabelProduk5.setHorizontalAlignment(SwingConstants.CENTER);
        jLabelProduk5.setText("Water");

        jLabel58.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel58.setText("20 Tk");

        jSpinner5.setFont(new Font("Rasa Medium", 1, 16)); 
        ...
        jLabel61.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel61.setText("Price:");

        jLabel62.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel62.setText("Quantity:");

        jLabel63.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel63.setText("Purchase:");

        jLabelProduk6.setFont(new Font("Potti Sreeramulu", 1, 20)); 
        jLabelProduk6.setHorizontalAlignment(SwingConstants.CENTER);
        jLabelProduk6.setText("Khichuri");

        jLabel65.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel65.setText("50 Tk");
        

        jSpinner6.setFont(new Font("Rasa Medium", 1, 16)); // 
        ...
        jLabel68.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel68.setText("Price:");

        jLabel69.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel69.setText("Quantity:");

        jLabel70.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel70.setText("Purchase:");

        jLabelProduk12.setFont(new Font("Potti Sreeramulu", 1, 20)); 
        jLabelProduk12.setHorizontalAlignment(SwingConstants.CENTER);
        jLabelProduk12.setText("Pizza");

        jLabel72.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel72.setText("75 Tk");

        jSpinner12.setFont(new Font("Rasa Medium", 1, 16)); 
        ...
        jLabelProduk7.setText("Coca-Cola");

        jLabel79.setFont(new Font("Potti Sreeramulu", 0, 17)); // 
        jLabel79.setText("25 Tk");
        ...
        jLabelProduk9.setText("Sandwich");

        jLabel86.setFont(new Font("Potti Sreeramulu", 0, 17)); // 
        jLabel86.setText("70 Tk");
        ...
        jLabelProduk8.setText("Lemontea");

        jLabel93.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel93.setText("25 Tk");
        ...
        jLabelProduk10.setText("Chawmin");

        jLabel100.setFont(new Font("Potti Sreeramulu", 0, 17)); // 
        jLabel100.setText("70 Tk");
        ...
        jLabelProduk11.setText("Biriwani");

        jLabel107.setFont(new Font("Potti Sreeramulu", 0, 17)); // 
        jLabel107.setText("130 Tk");
        ...
        jLabelProduk13.setText("Lacchi");

        jLabel114.setFont(new Font("Potti Sreeramulu", 0, 17)); 
        jLabel114.setText("70 Tk");
        ...
        jLabelProduk14.setText("Fried Rice");

        jLabel121.setFont(new Font("Potti Sreeramulu", 0, 17)); // 
        jLabel121.setText("120 Tk");
        ...
        jLabelProduk15.setText("Chicken Fry");

        jLabel128.setFont(new Font("Potti Sreeramulu", 0, 17)); // 
        jLabel128.setText("90 Tk");
    ...
    if (qtyIsZero(qty) && checkBox.isSelected()) {
        ...
        jTextArea.setText(jTextArea.getText() + x + ". " + label.getText()+"\t" +price +"\t" +qty + "\t" + String.format("%.2f", price) + "\n");
        dudate();

        
        // Write total and quantity to a text file
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("sales.txt", true))) {
           
            writer.write(
                         
                        
                    jTxtTime.getText() +  "\t"+ jTxtDate.getText() +"\t"+ label.getText() + "\t" + qty +"\t\t" + total + "\n" );
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void btnTotalActionPerformed(java.awt.event.ActionEvent evt) {
        if (total == 0.0) {
         ...
         try (BufferedWriter writer1 = new BufferedWriter(new FileWriter("totalsales.txt", true))) {
            writer1.write(
    ...
    public void Kashundi_Cafe() {
        int purchaseId = 15020 + (int) (Math.random() * 80800);
        jTextArea.setText("********************Kashundi Cafe*******************\n"
                + "                     North South University \n"
                + "      Block-B, Bashundara Residential Area, Dhaka\n"
                + "                    Phone: 01950466202        \n"
                + "Time: " + jTxtTime.getText() + "   Date: " + jTxtDate.getText() + "\n"
                + "Purchase Id: " + purchaseId + "\n"
                + "************************************************************\n"
                + "Item Name:\t"+"Price\t"+"Qty" + "\tT.Price\n");
    }
